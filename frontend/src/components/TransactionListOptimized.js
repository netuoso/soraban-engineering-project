...
import { 
  ...
  getCategoryTotalsOptimized
} from '../services/transactionsOptimized';
import { 
...
const TransactionListOptimized = () => {
  ...
  const fetchCategoryTotals = useCallback(async () => {
    try {
      const response = await getCategoryTotalsOptimized();
...
export default TransactionListOptimized;
